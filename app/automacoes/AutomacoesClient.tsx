...
export default function AutomacoesClient({ initialRole }: { initialRole: UiRole }) {
  ...
  if (loading) {
    return (
      <AdminRouteShell initialRole={initialRole}>
  ...
  return (
    <AdminRouteShell initialRole={initialRole}>
      ...
      <AdminPageHeader
        title="Automações"
        description="Controle os lembretes enviados pelo WhatsApp da igreja."
        actions={
